...
int main (int argc, char **argv)
{
	...
	std::string CSVfileName = "LocationManetExample.csv";
	...
	cmd.AddValue ("CSVfileName", "The name of the CSV output file name[Default:LocationManetExample.csv]", CSVfileName);
	cmd.Parse (argc, argv);
		...
		double dataStart, bool printRoutes, std::string CSVfileName)
{
	...
	std::string tr_name = "Location_Aided_Manet " + t_nodes + "Nodes_" + sTotalTime + "SimTime";
